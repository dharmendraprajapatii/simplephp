...
$(document).ready(function(){
    ...
    // });
            ...
            $.each(userData1, function(index1, value1){
                 $('.viewPostData').click(function(){
                    var idData1=$(this).attr('view-Data');
                    
                   if (idData1 == value1.publisher  && value1.type == 1) {
                       var href=value1.imageUrl;
                      $(".viewPostimage1").html("<img width='100px' height='100px' src='"+href+"'>");
                    //    $('#viewPostimage').html(value1.imageUrl);
                        $('.dataPost').html(value1.description);
