...
// // const analytics = firebase.l    ocsaleApplication;
// // console.log(analytics);

// const app = firebase.initializeApp(firebaseConfig, "locsaleAnalytics");
// const analytics = firebase.analytics;
// //console.log(app.name);  // "[DEFAULT]"
// //console.log(firebase.analytics().logEvent('notification_received'));
